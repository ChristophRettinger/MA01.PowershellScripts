...
- **Get-DeploymentInfo.ps1** - Calls Orchestra deployment APIs per server, supports version and landscape comparisons, supports optional scenario auto-rename alignment and JDBC URL visibility in landscape mode, and caches per-server credentials.
