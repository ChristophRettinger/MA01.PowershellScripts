...
- **Call-PatAuskunft.ps1** - Calls the PatAuskunft SOAP service for case-related identifiers, stores per-user credentials locally via CLIXML, and prints the decoded response XML.
