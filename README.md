...
- **Get-DeploymentInfo.ps1** - Calls Orchestra deployment APIs per server, supports version comparison or landscape comparison modes, and caches per-server credentials.
