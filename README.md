...
- **Create-ProcessModelOverview.ps1** - Parses ProcessModell_* XML files and generates Markdown overviews covering metadata, variables, business keys, element detail rows, and gateway edge conditions; supports single-file and folder modes with optional unused-variable analysis.
