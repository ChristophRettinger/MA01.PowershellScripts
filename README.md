...
- **Get-DeploymentInfo.ps1** - Calls Orchestra deployment scenarioInfos per server, caches per-server credentials, and compares scenario versions and states across one or more servers.
