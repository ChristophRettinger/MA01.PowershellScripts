...
- **Get-DeploymentInfo.ps1** - Calls Orchestra deployment scenarioInfos per server, caches per-server credentials, and shows colorized scenario version/state comparisons across one or more servers.
