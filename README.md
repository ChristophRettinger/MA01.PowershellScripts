...
- **Send-HL7Message.ps1** - Sends UTF-8 HL7 payload files to TLS/MLLP endpoints with selectable wire encoding, shows colorized HL7 separator characters in responses, and can save responses as UTF-8 files.
