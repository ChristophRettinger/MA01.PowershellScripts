...
- **Send-HL7Message.ps1** - Sends UTF-8 HL7 payload files over MLLP with selectable wire encoding and protocol mode (`Tcp`, `Tls`, `TlsWithCertificate`), shows colorized HL7 separator characters in responses, and can save responses as UTF-8 files.
