...
- **Get-PatientInfo.ps1** - Retrieves SUBFL HCM messages for a patient or case, exports structured JSON, and can copy fixed-width report output to the clipboard for email-friendly sharing.
