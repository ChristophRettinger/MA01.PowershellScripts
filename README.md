...
- **Handle-OrchestraGit.ps1** - Scans Orchestra git repositories, ensures required local excludes, reports fixed-width status lines with pending and update indicators, and supports status/update/pull/reset/clean actions.
